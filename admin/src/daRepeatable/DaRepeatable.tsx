...
import { DaylightSelect } from "../daylight/DaylightSelect";
...
export const DaRepeatable = (): React.ReactElement => {
  ...
  const initialValues = React.useMemo(() => pick(data, ["daylight"]), [data]);
    ...
    <>
      {data && (
        <Formik initialValues={initialValues} onSubmit={handleSubmit}>
          ...
          >
            <div>
              <DaylightSelect label="daylight" name="daylight.id" />
            </div>
          </Form>
        </Formik>
      )}
